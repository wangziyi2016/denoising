function [masks,ROInames,zs]=get_structure_mask_from_dicom(filename,ctdim,ctinfo,zsinput)
%
% [masks,ROInames,xs,ys,zs] = export_contour(filename,ctdim,ctinfo,zsinput)
% [masks,ROInames,xs,ys,zs] = export_contour(filename)
%
