function [mvy,mvx,mvz]=levelset_motion_local_affine_wo_gui(im1,im2,factor,maxiter,tor,localblocksizes,SplineApprGridSize,LowPassKernalSize,local_adaptive)
%{
Levelset deformable registration method, local affine approximation, without GUI.
