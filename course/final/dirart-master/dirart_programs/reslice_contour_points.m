function points_out = reslice_contour_points(points,zvalues)
%
% points_out = reslice_contour_points(points,zvalues)
%
% This function will slice the structure defined by the points at new
% slices points (given by zvalues)
%
